  ...
  return (
    <div className="w-full flex justify-center items-center py-5 px-4 absolute top-0 bg-white">
      <div className="md:w-fit w-full flex md:justify-center justify-between items-center gap-16">
        ...
        <div className="w-305 h-12">
          <Image src="/Search Field.png" alt="logo" width={100} height={80} className="w-full h-full object-cover"/>
        </div>
        ...
        <div className="md:flex hidden gap-12 text-sm font-medium text-[#989898]">
          ...
          <Link href={"/about"} className="hover:text-black hover:underline hover:font-semibold decoration-2 underline-offset-4">About</Link>
          <Link href={"/contact-us"} className="hover:text-black hover:underline hover:font-semibold decoration-2 underline-offset-4">Contact Us</Link>
          <Link href={"/blog"} className="hover:text-black hover:underline hover:font-semibold decoration-2 underline-offset-4">Blog</Link>
        </div>
